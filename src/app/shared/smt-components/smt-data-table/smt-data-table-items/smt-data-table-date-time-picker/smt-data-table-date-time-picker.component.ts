...
@Component({
  selector: 'app-smt-data-table-date-time-picker',
  templateUrl: './smt-data-table-date-time-picker.component.html',
  styles: [
  ]
})
export class SmtDataTableDateTimePickerComponent implements OnInit {
  @Input() config;
