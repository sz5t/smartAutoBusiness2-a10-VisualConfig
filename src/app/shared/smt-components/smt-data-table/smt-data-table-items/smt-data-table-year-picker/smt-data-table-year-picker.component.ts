...
@Component({
  selector: 'app-smt-data-table-year-picker',
  templateUrl: './smt-data-table-year-picker.component.html',
  styles: [
  ]
})
export class SmtDataTableYearPickerComponent implements OnInit {
  @Input() config;
