...
@Component({
  selector: 'app-cfg-form-property',
  templateUrl: './cfg-form-property.component.html',
  styles: [],
})
export class CfgFormPropertyComponent implements OnInit {
  ...
  async loadConfig(cmpt) {
    ...
    const data = await this.httpClient.get(`assets/vc/page/formComponent/${cmpt}.json?${timestamp}`).toPromise();
