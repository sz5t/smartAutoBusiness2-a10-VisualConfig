...
@Component({
  selector: 'app-cfg-l-form-attr-pop-component',
  templateUrl: './cfg-l-form-attr-pop-component.component.html',
  styles: [
  ]
})
export class CfgLFormAttrPopComponentComponent implements OnInit {
  @Input() public config;
