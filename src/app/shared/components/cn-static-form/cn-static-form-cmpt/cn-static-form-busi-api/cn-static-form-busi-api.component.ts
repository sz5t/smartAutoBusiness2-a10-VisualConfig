...
@Component({
  selector: 'app-cn-static-form-busi-api',
  templateUrl: './cn-static-form-busi-api.component.html',
  styles: [
  ]
})
export class CnStaticFormBusiApiComponent implements OnInit, AfterViewInit {
