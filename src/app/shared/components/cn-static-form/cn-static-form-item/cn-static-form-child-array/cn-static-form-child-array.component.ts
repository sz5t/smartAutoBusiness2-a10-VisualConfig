...
@Component({
  selector: 'app-cn-static-form-child-array',
  templateUrl: './cn-static-form-child-array.component.html',
  styles: [
  ]
})
export class CnStaticFormChildArrayComponent implements OnInit {
