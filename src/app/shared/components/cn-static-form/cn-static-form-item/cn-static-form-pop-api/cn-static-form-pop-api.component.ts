...
import { CnStaticFormApiComponent } from '../../cn-static-form-cmpt/cn-static-form-api/cn-static-form-api.component';
const components: { [type: string]: Type<any> } = {
  api: CnStaticFormApiComponent

};
@Component({
  selector: 'app-cn-static-form-pop-api',
  templateUrl: './cn-static-form-pop-api.component.html',
  styles: [
  ]
})
export class CnStaticFormPopApiComponent implements OnInit {
