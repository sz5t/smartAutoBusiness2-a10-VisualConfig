...
@Component({
  selector: 'app-cfg-attribute-assemble-ajax',
  templateUrl: './cfg-attribute-assemble-ajax.component.html',
  styles: [
  ]
})
export class CfgAttributeAssembleAjaxComponent extends CnComponentBase implements OnInit {
