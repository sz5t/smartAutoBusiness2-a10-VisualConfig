...
@Component({
  selector: 'app-cn-dashboard-chart',
  templateUrl: './cn-dashboard-chart.component.html',
  styles: [
  ]
})
export class CnDashboardChartComponent extends CnComponentBase implements OnInit, AfterViewInit {
  @Input() public config;
  @Input() tempData;
  @Input() initData;
  ...
  public createChart() {
    ...
    this.chart.annotation().arc({
      start: [0, 1],
      end: [this.dataList[this.value], 1],
      style: {
        stroke: '#1890FF',
        lineWidth: 18,
        lineDash: null,
