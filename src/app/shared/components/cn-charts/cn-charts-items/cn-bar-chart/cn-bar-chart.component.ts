...
@Component({
  selector: 'app-cn-bar-chart',
  templateUrl: './cn-bar-chart.component.html',
  styles: [
  ]
})
export class CnBarChartComponent extends CnComponentBase implements OnInit, AfterViewInit {
  @Input() public config;
  @Input() tempData;
  @Input() initData;
