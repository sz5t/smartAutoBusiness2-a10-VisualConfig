...
@Component({
  selector: 'app-cn-flow-attr-setting-more',
  templateUrl: './cn-flow-attr-setting-more.component.html',
  styles: [
    `.toolbarGroup {
      margin-right:8px;
      float:right;
...
export class CnFlowAttrSettingMoreComponent extends CnComponentBase implements OnInit {
  @Input() public config;
